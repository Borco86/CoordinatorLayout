...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Twoja stara");

        CardView cardView = (CardView) findViewById(R.id.red_card_view);
        SwipeDismissBehavior<CardView> swipeDismissBehavior = new SwipeDismissBehavior<CardView>();
        swipeDismissBehavior.setListener(new SwipeDismissBehavior.OnDismissListener() {
            @Override
            public void onDismiss(View view) {
                Toast.makeText(MainActivity.this, "O nie! Ktoś wyrzucił CardView za ekran!", Toast.LENGTH_SHORT).show();
            }
